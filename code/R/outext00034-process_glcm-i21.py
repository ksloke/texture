# Outex 00034 9 Sep 2021 process glcm only and save into 
# glcm-i21-64L.npy or
...
for file in files:
  ...
  if(u>=1360): #ignore the rest of files OUTEX TC 00034
      break
...
with open('outex-00034-glcm-i21-16L.npy','wb') as f: 
    np.save(f,images)
    np.save(f,labels)