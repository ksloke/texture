# Outex 00031 17 Sep 2021 process glcm only and save into 
# glcm-i21-64L.npy or
...
#00031 has extra sets of separate test images - we ignore them
directory = '../Texture/texure_2/Outex_TC_00034/Outex-TC-00031/images' 
# size = 128x128
# Total 1360 
...
for file in files:
  ...
  if(u>=1360): #ignore the rest of files OUTEX TC 00031
      break
...
# or glcm-i21-64L.npy
#outex-00034-glcm-i21-16L.npy
#mbt-glcm-i21-16L.npy
with open('outex-00031-glcm-i21-16L.npy','wb') as f: 
    np.save(f,images)
    np.save(f,labels)